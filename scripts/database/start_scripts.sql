...
ALTER TABLE user_journey ADD CONSTRAINT fk_station_1 FOREIGN KEY(swipe_in_station_id) REFERENCES metro_station(station_id);

ALTER TABLE user_journey ADD CONSTRAINT fk_station_2 FOREIGN KEY(swipe_out_station_id) REFERENCES metro_station(station_id);
